...
void solve() {
  ...
  if(t.substr(0, s.length()) == s & s == t.substr(t.length() - s.length(), s.length())) cout << 0;
  else if(t.substr(0, s.length()) == s) cout << 1;
  else if(t.substr(t.length() - s.length(), s.length()) == s) cout << 2;
  else cout << 3;
